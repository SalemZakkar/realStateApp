...
class _UserRemoteSourceImpl implements UserRemoteSourceImpl {
  _UserRemoteSourceImpl(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<BaseResponse<UserModel>> getMine() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
