...
class PropertyStatusDescriptionWidget extends StatefulWidget {
  ...
  @override
  State<PropertyStatusDescriptionWidget> createState() =>
      _PropertyStatusDescriptionWidgetState();
}

class _PropertyStatusDescriptionWidgetState
    extends State<PropertyStatusDescriptionWidget> {
          ...
          child: Column(
            ...
            children: [
              ...
              if (widget.property.status == PropertyStatus.unactive) ...[
                Text(
                  context.translation.postIsUnActivatedAndNotVisibleToAnyOne,
                ),
                SizedBox(
                  width: MediaQuery.of(context).size.width,
                  child: ElevatedButton(
