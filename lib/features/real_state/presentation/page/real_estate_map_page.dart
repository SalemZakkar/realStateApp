...
class RealEStateMapPage extends StatefulWidget {
  static String path = '/real_state_map_page';

  const RealEStateMapPage({super.key});

  @override
  State<RealEStateMapPage> createState() => _RealEStateMapPageState();
}

class _RealEStateMapPageState extends State<RealEStateMapPage> {
              ...
              child: MapClusterWidget<RealEstate>(
                ...
                normalMarkerBuilder: (context, item) {
                  ...
                  return MarkerData.fromWidget(
                    child: RealEstateMarkerWidget(realEstate: item, size: size),
                    size: size,
                  );
                },
                onItemTap: (item) {
                  ...
                  return MarkerData.fromWidget(
                    child: Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(color: context.appColorSchema.white),
                      ),
                    ),
                    size: Size(40, 40),
                  );
