...
@injectable
class RealEstateMapGetCubit extends Cubit<BaseState<List<RealEstate>>> {
  RealEstateMapGetCubit(this.repository) : super(BaseState());

  RealEstateRepository repository;

  late RealEstateGetParams params;

  void get({required RealEstateGetParams params}) async {
    this.params = params;
